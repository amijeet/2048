...
function changeTheme() {
	if (theme % 2 == 0) {
		document.body.style.backgroundImage =
			"linear-gradient(120deg, #f0931e, #facb0f)";
		document.getElementById("themeChanger").style.backgroundColor =
			"transparent";
	} else {
		document.body.style.backgroundImage =
			"linear-gradient(120deg, #f1062d, #c70fdb)";
	}
	theme += 1;
}
...
function end() {
	alert(
		"Your game is over, your score is " +
